<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Foody.User.Default" %>
      ...
      <div class="container ">
        <div class="row">
          ...
          <div class="col-md-6  ">
            <div class="box ">
              <div class="img-box">
                <img src="../Template/images/o2.jpg" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Pizza Days
